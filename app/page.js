    ...
    <nav className="flex items-center justify-between bg-[#13151a] border border-[#2a2d36] rounded-2xl px-4 md:px-6 py-2.5 md:py-3 shrink-0 mb-4 md:mb-6">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        {user ? (
          ...
          <button onClick={iniciarSesionGoogle} className="bg-white text-black font-bold px-4 py-2 rounded-lg text-sm hover:bg-gray-200 transition-all flex items-center gap-2">
