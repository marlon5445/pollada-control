...
export default function AppPollada() {
  ...
  const [pasoLogin, setPasoLogin] = useState('correo') 
  ...
  const totalPlatosVendidos = tarjetasVendidas.length;
  const entregadosCount = tarjetasSeguras.filter(t => t.estado_entrega === 'entregado').length;
  const pendientesEntregaCount = totalPlatosVendidos - entregadosCount;
      ...
      <div className="min-h-screen bg-[#0f1115] text-white p-4 md:p-8 font-sans pb-32">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 md:gap-4 mb-6">
            ...
            <div className="bg-[#1a1d24] py-3 px-4 rounded-xl border border-[#2a2d36]">
              <p className="text-gray-400 text-xs font-bold uppercase">Total a Recaudar</p>
              ...
              <table className="w-full text-sm text-left text-gray-300">
                <thead className="text-xs uppercase bg-[#0f1115] text-gray-500 border-b border-[#2a2d36]">
                  <tr>
                    ...
                    <th className="px-5 py-4">Total Pedido</th>
  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-white p-4 md:p-8 font-sans pb-32">
      ...
      {/* MÉTRICAS FÍSICAS DE LA MATRIZ DE ENTREGAS */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-6">
        <div className="bg-[#1a1d24] py-3 px-4 md:py-4 md:px-5 rounded-xl border border-[#2a2d36] border-l-4 border-l-[#00e5ff]">
          <p className="text-gray-400 text-[10px] md:text-xs font-bold mb-0.5 uppercase tracking-wider">Platos Vendidos / Asignados</p>
          <p className="text-xl md:text-2xl font-black text-[#00e5ff]">{totalPlatosVendidos} <span className="text-xs text-gray-500">tarjetas</span></p>
        </div>
        <div className="bg-[#1a1d24] py-3 px-4 md:py-4 md:px-5 rounded-xl border border-[#2a2d36] border-l-4 border-l-[#f59e0b]">
          <p className="text-gray-400 text-[10px] md:text-xs font-bold mb-0.5 uppercase tracking-wider">Platos por Entregar</p>
          <p className="text-xl md:text-2xl font-black text-[#f59e0b]">{pendientesEntregaCount} <span className="text-xs text-gray-500">en cocina</span></p>
        </div>
        <div className="bg-[#1a1d24] py-3 px-4 md:py-4 md:px-5 rounded-xl border border-[#2a2d36] border-l-4 border-l-[#ccff00]">
          ...
          <p className="text-xl md:text-2xl font-black text-[#ccff00]">{entregadosCount} <span className="text-sm md:text-base text-gray-500">/ {totalPlatosVendidos}</span></p>
        </div>
      </div>
